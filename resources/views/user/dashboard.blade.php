<x-app-layout>
  ...
  <div class="row  col-lg-12 " data-aos="zoom-in" data-aos-delay="200">
    <div class=" d-flex col-lg-12 ">
      ...
      <a href="{{ route('user.deposit.create')}}" class="col-lg-5 btn-get-started scrollto" data-bs-whatever="Deposit"
        style="margin-left: 10px;">Deposit</a>
    </div>
    <div class=" d-flex col-lg-12 ">
    ...
    <div class=" d-flex col-lg-12 ">
      ...
      <a href="#staticBackdropp" class="col-lg-5 btn-get-started scrollto" data-bs-toggle="modal"
        data-bs-target="#staticBackdropp" data-bs-whatever="Change PIN" style="margin-left: 10px;">Change PIN</a>
          ...
          <div class="col-lg-12 mt-5 mt-lg-0 ">
            <form action="{{ route('user.update.password')}}" method="post" id="myForm">
              ...
              <div class="form-group mb-5">
                <label class="form-lable-control h6" style="color: black" for="name">type new password</label>
