                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <label class="block text-sm">
                                ...
                                <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input 
                                    @error('name') border-red-600  focus:border-red-400
                                    focus:outline-none focus:shadow-outline-red @enderror" id="name" type="text"
                            ...
                            <label class="block mt-4 text-sm">
                                ...
                                <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input 
                                    ...
                                    focus:outline-none focus:shadow-outline-red @enderror" id="email" type="text"
                            ...
                            <label class="block mt-4 text-sm">
                                ...
                                @error('password')<p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                                @enderror
                            </label>
                            ...
                            <label class="block mt-4 text-sm">
                                ...
                                @error('password_confirmation')<p class="text-red-500 text-xs italic mt-2">{{ $message
                                    }}</p>@enderror
                            </label>
